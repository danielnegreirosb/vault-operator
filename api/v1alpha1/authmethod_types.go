...
type AuthMethodStatus struct {
	...
	// conditions represent the current state of the AuthMethod resource.
...
type AuthMethod struct {
	...
	// spec defines the desired state of AuthMethod
	// +required
	Spec AuthMethodSpec `json:"spec"`

	// status defines the observed state of AuthMethod
	// +optional
	Status AuthMethodStatus `json:"status,omitzero"`
}
