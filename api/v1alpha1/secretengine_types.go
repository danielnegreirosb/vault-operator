...
type SecretEngineStatus struct {
	...
	// conditions represent the current state of the SecretEngine resource.
...
// +kubebuilder:printcolumn:name="Synchronized",type=string,JSONPath=".status.synchronized",description="Current Status"
...
type SecretEngine struct {
	...
	// spec defines the desired state of SecretEngine
	// +required
	Spec SecretEngineSpec `json:"spec"`

	// status defines the observed state of SecretEngine
	// +optional
	Status SecretEngineStatus `json:"status,omitzero"`
}
